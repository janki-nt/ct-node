...
export class MatProd implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Coach Trigger Live',
		name: 'matProd',
		icon: 'file:matprod.svg',
		group: ['transform'],
		version: 1,
		subtitle: '={{$parameter["operation"] + ": " + $parameter["resource"]}}',
		description: 'Perform actions with the Coach API',
		defaults: {
			name: 'Coach Trigger Live',
		},
		inputs: ['main'],
		outputs: ['main'],
		credentials: [
				...
				options: [
					{
						...
						routing: {
							request: {
								method: 'POST',
								url: `https://www.coachtriggerapp.com/crmApi/get-user-data`,
								headers: {
				...
				options: [
					{
						...
						routing: {
							request: {
								method: 'POST',
								url: `https://www.coachtriggerapp.com/crmApi/get-current-kpi-value`,
								headers: {
									'companyId': '={{$credentials.companyId}}',
									'apiKey': '={{$credentials.apiKey}}',
								},
					...
					},
					{
						...
						routing: {
							request: {
								method: 'POST',
								url: `https://www.coachtriggerapp.com/crmApi/get/master/activities`,
								headers: {
									'companyId': '={{$credentials.companyId}}',
									'apiKey': '={{$credentials.apiKey}}',
								},
					...
					},
					{
						...
						routing: {
							request: {
								method: 'POST',
								url: `https://www.coachtriggerapp.com/crmApi/get/team/activities`,
								headers: {
									'companyId': '={{$credentials.companyId}}',
									'apiKey': '={{$credentials.apiKey}}',
								},
					...
					},
					{
						...
						routing: {
							request: {
								method: 'POST',
								url: `https://www.coachtriggerapp.com/crmApi/get/user/activities`,
								headers: {
									'companyId': '={{$credentials.companyId}}',
									'apiKey': '={{$credentials.apiKey}}',
								},
					...
					},
					{
						...
						routing: {
							request: {
								method: 'PUT',
								url: `https://www.coachtriggerapp.com/crmApi/update-kpi`,
								headers: {
									'companyId': '={{$credentials.companyId}}',
									'apiKey': '={{$credentials.apiKey}}',
								},
				...
				options: [
					{
						...
						routing: {
							request: {
								method: 'POST',
								url: `https://www.coachtriggerapp.com/crmApi/message/update`,
								headers: {
									'companyId': '={{$credentials.companyId}}',
									'apiKey': '={{$credentials.apiKey}}',
								},
